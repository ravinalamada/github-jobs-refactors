  ...
  return (
    ...
    <JobDetails>
      <JobDetails.Container>
        ...
        <JobDetails.Link dangerouslySetInnerHTML={{__html: jobDetails.how_to_apply}} />
      </JobDetails.Container>
      <JobDetails.Container>
        <JobDetails.Wrapper>
          <div>
            <JobDetails.Title>{jobDetails.title}</JobDetails.Title>
            <Buttons>{jobDetails.type}</Buttons>
          </div>
          <div>
            ...
            <JobDetails.SmallText>{days} days ago</JobDetails.SmallText>
          </div>
        </JobDetails.Wrapper>
        <JobDetails.Frame>
          <div>
            <JobDetails.Image src={jobDetails.company_logo} alt="Image"/>
            <JobDetails.SubTitle>{jobDetails.company}</JobDetails.SubTitle>
          </div>
          <div>
            ...
            <JobDetails.SmallText>{jobDetails.location}</JobDetails.SmallText>
          </div>
        </JobDetails.Frame>
